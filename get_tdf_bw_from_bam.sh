...
#path to the directorie(s) of the bam files
...
#associative array that links the original name (key) of the bam file, and the name (value) you would like to give it (example here as bam we have D268T24.unique.bam, we want later to have bigwig/tdf files with name FFPE_normal_1)
...
for one_condition in ${!condition_list[*]};do
  ...
  if [[ ! -f $file ]];then
     ...
     echo "no bam file for ${one_condition}${separator} !"
